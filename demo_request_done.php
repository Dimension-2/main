...
<head>
    ...
    <title><?php echo getContent('demo_request_done_title'); ?></title>
...
<body>
    <div class="confirmation-card">
        ...
        <h1>
            <span class="icon">&#x2705;</span> <?php echo getContent('demo_request_done_heading'); ?>
        </h1>
        <p>
            <?php echo getContent('demo_request_done_paragraph_1'); ?>
        </p>
        <p>
            <?php echo getContent('demo_request_done_paragraph_2'); ?>
        </p>
        <a href="index.php" class="btn-home"><?php echo getContent('demo_request_done_home_button'); ?></a>
    </div>
